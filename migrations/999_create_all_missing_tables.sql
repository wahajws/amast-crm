...
-- Generated: 2025-12-19T12:43:42.506Z
-- ============================================

-- Table: accounts (CRM Accounts/Companies table)
...
-- Table: company_profiles (Company profiles for lead generation)
...
-- Table: contacts (CRM Contacts table)
...
-- Table: email_attachments (Email attachments metadata)
...
-- Table: email_campaigns (Email campaigns and tracking)
...
-- Table: email_sync_logs (Logs of email sync operations)
...
-- Table: emails (Synced emails from Gmail)
...
-- Table: gmail_label_sync_settings (Gmail label sync settings per user)
...
-- Table: notes (CRM Notes table (tagged to contacts or accounts))
...
-- Table: opportunities (CRM Opportunities table)
...
-- Table: proposals (CRM Proposals table)
...
-- Table: reminders (CRM Reminders table (tagged to contacts or accounts))
